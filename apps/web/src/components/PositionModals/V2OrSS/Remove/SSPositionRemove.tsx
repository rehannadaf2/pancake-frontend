...
import { Box, Button, FlexGap, PreTitle, RowBetween, Slider, Text } from '@pancakeswap/uikit'
...
const SSPositionRemoveInner = ({ position, poolInfo }: SSPositionRemoveProps) => {
  ...
  const { pair, parsedAmounts, error } = useStableDerivedBurnInfo(currency0, currency1)
